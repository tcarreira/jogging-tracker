    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weather', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.Weather')),
            ],
            options={
                'permissions': [('crud_others_activities', 'Can change the any activity (owned by other user)')],
            },
        ),
    ]
